...
public interface IContractField<T>
{
   ...
   */
  void setValueAccess(Function<ContractFieldValues, T> valueAccess);
   ...
   */
  default void setValueAccess(Function<ContractFieldValues, T> valueAccess, T defaultValue)
  {
   ...
   */
  default void setValueToDefault()
  {
  ...
  default void setFrom(Values values)
  {
    {
      Function<ContractFieldValues, T> valueAccess = getValueAccess();
      if (valueAccess != null)

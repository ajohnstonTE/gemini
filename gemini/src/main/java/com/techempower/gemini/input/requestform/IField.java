...
public interface IField<T>
{
   ...
   */
  IField<T> setMultivalued(boolean multivalued);
   ...
   */
  default IField<T> setValueAccess(Function<ValueAccess, T> valueAccess, T defaultValue)
  {
   ...
   * @param defaultValue
   */
  IField<T> setDefaultValue(T defaultValue);
